/** Full CV text (from HeesuYun_CV.pdf). Use *single asterisks* for italics; see `cvRichSegments`. */
...
export type EducationEmploymentEntry = {
  period: string;
  title: string;
  /** One paragraph, or several (e.g. PI vs. thesis). */
...
export const EDUCATION_EMPLOYMENT_TIMELINE: readonly EducationEmploymentEntry[] =
  [
    ...
    },
    {
      ...
      detail: [
        "PI: Dr. Joshua Hartshorne.",
        "*Honors thesis: The Impact of Linguistic Structures in First Language on Second Language Acquisition: A Study of English Language Learners with 32 Distinct First Languages.*",
      ],
    },
  ] as const;
...
export const LANGUAGES: readonly string[] = [
  "🇰🇷 Korean (Native); 🇺🇸 English (Fluent); 🇨🇳 Chinese (Intermediate); 🇯🇵 Japanese (Elementary).",
] as const;
